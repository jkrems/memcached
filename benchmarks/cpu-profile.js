 ...
 */
function CPUProfileDataModel(profile)
{
...
CPUProfileDataModel.prototype = {
    ...
    _normalizeTimestamps: function()
    {
        ...
        for (var i = 0; i < timestamps.length; ++i)
            timestamps[i] /= 1000;
        var averageSample = (peekLast(timestamps) - timestamps[0]) / (timestamps.length - 1);
        // Add an extra timestamp used to calculate the last sample duration.
        this.timestamps.push(peekLast(timestamps) + averageSample);
        this.profileStartTime = timestamps[0];
        this.profileEndTime = peekLast(timestamps);
    },
...
module.exports = CPUProfileDataModel;
